...
mkdir triton/models/rice_type_image_detection/$MODEL_VERSION
echo "Converting onnx model to TensorRT model of suitable version..."
bash scripts/convert2tensorrt_8.6.sh $ONNX_PATH rice_type_image_detection triton/models $MODEL_VERSION
