...
from modules.rice_type_dataset import RiceTypeDataset
from utilities.data_handler import download_data, ensure_data_unpacked
...
class ViTDataModule(pl.LightningDataModule):
    ...
    def train_test_split(
    ...
    ) -> tuple[RiceTypeDataset, RiceTypeDataset]:
        ...
        custom_train_dataset = RiceTypeDataset.from_dataset(
            train_dataset,
            processor=get_processor(),
            transform=ViTDataModule.train_transforms,
        )
        custom_test_dataset = RiceTypeDataset.from_dataset(
            test_dataset,
            processor=get_processor(),
    ...
    def train_val_split(
        ...
        custom_val_dataset = RiceTypeDataset.from_dataset(
            val_dataset,
            processor=get_processor(),
            transform=ViTDataModule.val_transforms,
        )
    ...
    def setup(self, stage: tp.Optional[str] = None):
        ...
        self.dataset = RiceTypeDataset.from_data_path(
            self._data_dir,
            self._num_labels,
            processor=get_processor(),
            randomize=True,
